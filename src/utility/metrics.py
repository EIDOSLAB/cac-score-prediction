...
def regression_roc_auc_score(y_true, y_pred, num_rounds = 1000):
  """
...
def mean_absolute_error(y_true, y_pred):
    """
    Returns the abs between y_true and y_pred
        
    Parameters:
    ----------
    y_true: array-like of shape (n_samples,). Binary or continuous target variable.
    y_pred: array-like of shape (n_samples,). Binary or continuous pred variable.
        
    Yields:
    -------
    abs: sum of abs between y_true and y_pred
